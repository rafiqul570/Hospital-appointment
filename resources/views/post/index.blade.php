...
<body>
    ...
    <div class="card pd-20 pd-sm-40 form-layout form-layout-5">
      <div class="d-flex justify-content-between">
        ...
        <h5><a  href="{{route('post.create')}}" class="btn btn-info text-light">Add Post</a></h5>
      </div>
             ...
             <tbody>
               ...
               <tr>
                 ...
                 <td>
                  ...
                  <br>
                  <a class="btn btn-sm btn-primary mt-2" href="{{route('post.editImage', $data->id)}}">Update Image</a> 
                </td>
                
                 <td>
                    <a href="{{route('post.edit', $data->id)}}">Edit</a> ||
                    <a onclick="return confirm('Are you sure ?')" href="{{route('post.delete', $data->id)}}"><span class="tx-danger"> Delete</span></a>
                 </td>
               </tr>
               @endforeach
             </tbody>
